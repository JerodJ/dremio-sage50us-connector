...
@SourceType(value = "Sage50USARP", label = "Sage50US",uiConfig = "sage50us-layout.json")
public class Sage50USConf extends AbstractArpConf<Sage50USConf> {
  private static final String ARP_FILENAME = "arp/implementation/sage50us-arp.yaml";
  private static final ArpDialect ARP_DIALECT =
      AbstractArpConf.loadArpFile(ARP_FILENAME, (ArpDialect::new));
  private static final String DRIVER = "cdata.jdbc.sage50us.Sage50USDriver";
